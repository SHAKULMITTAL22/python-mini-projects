...
class Test_TicTacToeCheckWin:
    ...
    def test_check_win_no_condition_met(self):
        ...
        result = check_win(player)
        # Assert
        assert result == False, "Should return False when no win condition is fully met by the same player"
    ...
    def test_check_win_partial_occupation(self):
        ...
        result = check_win(player)
        # Assert
        assert result == False, "Should return False when only part of a win condition is occupied by the same player"
    ...
    def test_check_win_mixed_players(self):
        ...
        result = check_win(player)
        # Assert
        assert result == False, "Should return False when a win condition is occupied by mixed players"
    ...
    def test_check_win_exact_match(self):
        ...
        result = check_win(player)
        # Assert
        assert result == True, "Should return True when exactly the squares in a win condition are occupied by the same player"
